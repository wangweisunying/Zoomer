...
public class Zoomer_Unit {
    ...
    private String test_code, julien_barcode , pillarId, row, col;
    private double unit;

    public Zoomer_Unit(String test_code, String julien_barcode, double unit, String pillarId, String row, String col) {
